...
const slider_data: DataType[] = [
  {
    id: 1,
    title: "Steigern Sie Ihre Produktivität mit Prozessautomatisierung",
    img: slider_thumb_1,
  },
  {
    id: 2,
    title: "Verwirklichen Sie Ihre Vision mit innovativen Weblösungen",
    img: slider_thumb_2,
  },
  {
    id: 2,
    title: "Zukunft erleben: AI, die begeistert",
    img: slider_thumb_2,
  },
                      ...
                      <div className={`${i === 0 ? "tp-slider-2-wrap-bland" : ""}`}>
                        <div className="tp-slider-2-wrap">
                          ...
                          <div className="tp-slider-2-contact">
                            <h2 className="tp-slider-2-title">{item.title}</h2>
                          </div>
